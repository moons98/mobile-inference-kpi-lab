...
| `vae_encoder_int8_qdq.onnx` | 33MB | `scripts/sd/quant_runpod.py` | ✅ CosSim 0.985 | `jp4woq22g` ⏳ |
| `vae_encoder_qai_int8.onnx` + `.data` | 0.4MB + 131MB | QAI Hub quantize (`jgjlm961p`) | ✅ CosSim 0.984 | `j5q2kj245` (30MB) |
...
| `unet_int8_qdq.onnx` + `.data` | 3.1MB + 820MB | `scripts/sd/quant_runpod.py` | ✅ CosSim 0.983 | `jp3m3krng` ⏳ |
...
| `vae_decoder_int8_qdq.onnx` | 48MB | `scripts/sd/quant_runpod.py` | ✅ CosSim 0.960 | `jpx1jvz8g` ⏳ |
| `vae_decoder_qai_int8.onnx` + `.data` | 0.5MB + 189MB | QAI Hub quantize (`j57dwm1n5`) | ✅ CosSim 0.968 | `j561jk10p` (46MB) |
...
`scripts/sd/eval_sd_inpaint_quality.py` (8 samples, component-level FP32 vs INT8)
...
| unet | Custom QDQ | 0.983 | 0.183 | 27.9dB | Marginal |
